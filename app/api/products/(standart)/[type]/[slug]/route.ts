...
export async function GET(
    ...
    try {
        ...
        if (!product) {
            return NextResponse.json({ message: `There are no products with slug: ${slug}.` }, { status: 404 })
        }
        ...
        return NextResponse.json({ message: "Product was fetched successufully.", [type.toLowerCase()]: product, recommended }, { status: 201 })
    } catch (e) {
        console.log(e);
